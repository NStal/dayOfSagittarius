...
(function(exports){
    Dock.prototype._init = function(facility){
    ...
    Dock.prototype.prepareCanvas = function(){
	this.canvas.width = $(this.canvas).width();
	this.canvas.height = $(this.canvas).height(); 
	console.log(this.canvas.width);
    }
    Dock.prototype.onClickSave = function(eq){
    ...
    Dock.prototype.changeShip = function(ship){
